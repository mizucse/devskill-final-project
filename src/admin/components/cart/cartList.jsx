      ...
      <Table dataSource={data}>
        <ColumnGroup title="Cart Products">
            ...
            render={(text, record) => (
              <Space size="middle">
                <Image
                  ...
                  src={BASE_URL + record.productId.image}
                />
              </Space>
            )}
          />
          <Column
            ...
            dataIndex="title"
            key="title"
            render={(text, record) => record.productId.title}
          />
          <Column
            title="Qty"
            dataIndex="quantity"
          ...
          <Column
            title="Total"
            render={(text, record) => record.quantity * record.productId.price}
          />
        </ColumnGroup>
      </Table>
      <div>
        <Button onClick={(e) => checkOut()} type="primary">
          Proceed to Checkout
        </Button>
      </div>
    </>
